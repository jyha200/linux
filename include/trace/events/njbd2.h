...
#undef TRACE_SYSTEM
#define TRACE_SYSTEM njbd2

#if !defined(_TRACE_NJBD2_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_NJBD2_H
...
DECLARE_EVENT_CLASS(njbd2_commit,
...
DEFINE_EVENT(njbd2_commit, njbd2_start_commit,
...
DEFINE_EVENT(njbd2_commit, njbd2_commit_locking,
...
DEFINE_EVENT(njbd2_commit, njbd2_commit_flushing,
...
DEFINE_EVENT(njbd2_commit, njbd2_commit_logging,
...
DEFINE_EVENT(njbd2_commit, njbd2_drop_transaction,
...
TRACE_EVENT(njbd2_submit_inode_data,
...
DECLARE_EVENT_CLASS(njbd2_handle_start_class,
...
DEFINE_EVENT(njbd2_handle_start_class, njbd2_handle_start,
	TP_PROTO(dev_t dev, unsigned long tid, unsigned int type,
		 unsigned int line_no, int requested_blocks),
...
DEFINE_EVENT(njbd2_handle_start_class, njbd2_handle_restart,
	TP_PROTO(dev_t dev, unsigned long tid, unsigned int type,
		 unsigned int line_no, int requested_blocks),
...
TRACE_EVENT(njbd2_handle_extend,
	TP_PROTO(dev_t dev, unsigned long tid, unsigned int type,
...
TRACE_EVENT(njbd2_handle_stats,
	TP_PROTO(dev_t dev, unsigned long tid, unsigned int type,
...
TRACE_EVENT(njbd2_checkpoint_stats,
	TP_PROTO(dev_t dev, unsigned long tid,
...
TRACE_EVENT(njbd2_update_log_tail,
...
TRACE_EVENT(njbd2_write_superblock,
...
TRACE_EVENT(njbd2_lock_buffer_stall,
...
DECLARE_EVENT_CLASS(njbd2_journal_shrink,
...
DEFINE_EVENT(njbd2_journal_shrink, njbd2_shrink_count,
...
DEFINE_EVENT(njbd2_journal_shrink, njbd2_shrink_scan_enter,
...
TRACE_EVENT(njbd2_shrink_scan_exit,
...
TRACE_EVENT(njbd2_shrink_checkpoint_list,
