...
/*
 * KUnit test of next4 inode that verify the seconds part of [a/c/m]
 * timestamps in next4 inode structs are decoded correctly.
 */
...
KUNIT_ARRAY_PARAM(next4_inode, test_data, timestamp_expectation_to_desc);
 ...
 *  Documentation/filesystems/next4/inodes.rst.
 */
static void inode_test_xtimestamp_decoding(struct kunit *test)
{
	...
	next4_decode_extra_time(&timestamp,
...
static struct kunit_case next4_inode_test_cases[] = {
	KUNIT_CASE_PARAM(inode_test_xtimestamp_decoding, next4_inode_gen_params),
	{}
};

static struct kunit_suite next4_inode_test_suite = {
	.name = "next4_inode_test",
	.test_cases = next4_inode_test_cases,
};

kunit_test_suites(&next4_inode_test_suite);
